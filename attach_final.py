...
infile2 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/glycan_pr_5_pct.txt", "r")
outfile1 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/glycan_5_coord.txt", "w")
outfile2 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/glycan_5_gro.txt", "w")
outfile3 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/glycan_5_def.txt", "w")
outfile4 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/glycan_5_bond.txt", "w")
outfile5 = open("/home_b/gargi/project_muc/compact_muc2/5_percent_gly/abandoned2.txt", "w")
